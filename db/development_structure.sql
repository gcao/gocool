...
CREATE TABLE "uploads" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(255) NOT NULL, "file_file_name" varchar(255) NOT NULL, "upload_content_type" varchar(255), "file_file_size" integer, "upload_updated_at" datetime, "status" varchar(255), "status_detail" varchar(255), "created_at" datetime, "updated_at" datetime);
