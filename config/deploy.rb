...
# # extension ".pub".
# ssh_options[:keys] = ["#{ENV['HOME']}/.ec2/amazon.pem"]
# 
# # Your EC2 instances. Use the ec2-xxx....amazonaws.com hostname, not
# # any other name (in case you have your own DNS alias) or it won't
# # be able to resolve to the internal IP address.
# set :ec2_host, "ec2-12-xx-xx-xx.z-1.compute-1.amazonaws.com"
# role :web,      ec2_host
# role :memcache, ec2_host
# role :db,       ec2_host, :primary => true
...
#   # desired.
#   # NOTE: this only applies if you are not using EBS
#   :archive_to_bucket => "gocool_db_archive",
