class Admin::GamesController < Admin::BaseController
  active_scaffold :game do |config|
    ...
    config.columns[:winner].label = I18n.t("games_widget.winner")
    ...
    config.list.columns.remove :gaming_platform_id, :played_at_raw
    config.show.columns.remove :gaming_platform, :played_at_raw
